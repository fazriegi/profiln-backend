...
type IAuthRepository interface {
	...
	UpdateVerifiedEmail(otp string, email string) (authSqlc.User, error)
...
func (r *AuthRepository) UpdateVerifiedEmail(otp string, email string) (authSqlc.User, error) {
